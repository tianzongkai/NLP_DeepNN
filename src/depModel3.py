...
class DepModel:
    def __init__(self, pickle_path = 'pickle_path_6_embedding', saved_network_path='trained_network_6_embedding'):
        '''
        ...
        self._vocab, self._net_properties = pickle.load(open(pickle_path, 'r'))
        self.network = Network(self._vocab, self._net_properties)
        self.network.load(saved_network_path)
